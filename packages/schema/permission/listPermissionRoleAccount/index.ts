...
import { listPermissionRoleAccountParamsRequestSchema } from './request.schema';
...
export const listPermissionRoleAccountSchema = {
  ...
  params: listPermissionRoleAccountParamsRequestSchema,
  response: {
    200: Type.Object(
      {
        ...
        message: Type.String(),
        data: listPermissionRoleAccountResponseSchema,
      },
