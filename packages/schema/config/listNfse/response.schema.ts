...
export const listNfseResponseSchema = Type.Object({
  ...
  integration_base_url: Type.Union([Type.String(), Type.Null()]),
...
export type ListNfseResponse = Static<typeof listNfseResponseSchema>;
