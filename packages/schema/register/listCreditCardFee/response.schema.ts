...
export const listRegisterCreditCardFeeResponseSchema = Type.Object({
...
export type ListRegisterCreditCardFeeResponse = Static<
  typeof listRegisterCreditCardFeeResponseSchema
>;
