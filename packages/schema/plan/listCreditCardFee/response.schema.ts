...
export const listPlanCreditCardFeeResponseSchema = Type.Object({
...
export type ListPlanCreditCardFeeResponse = Static<
  typeof listPlanCreditCardFeeResponseSchema
>;
