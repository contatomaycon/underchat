...
export const listInternalChatContactsRequestSchema = Type.Object({
...
export type ListInternalChatContactsRequest = Static<
  typeof listInternalChatContactsRequestSchema
>;
