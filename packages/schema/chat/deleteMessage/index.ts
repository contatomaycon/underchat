...
import {
  deleteMessageOptionalHttpBodySchema,
...
export const deleteMessageSchema = {
  description:
    'Remove uma mensagem do chat. Se operation_id for omitido, a resposta devolve um UUIDv7 gerado; reutilize-o para retry seguro.',
  ...
  body: deleteMessageOptionalHttpBodySchema,
  response: {
    200: Type.Object(
      {
