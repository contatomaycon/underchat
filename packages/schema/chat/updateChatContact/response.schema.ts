...
export const updateChatContactResultSchema = Type.Object({
  chat_id: Type.String(),
...
export const updateChatContactResponseSchema = Type.Object({
  id: Type.Optional(Type.Union([Type.String(), Type.Null()])),
  status: Type.Boolean({ const: true }),
  message: Type.String(),
  data: Type.Union([updateChatContactResultSchema, Type.Null()]),
});

export type UpdateChatContactResult = Static<
  typeof updateChatContactResultSchema
>;
export type UpdateChatContactResponse = Static<
  typeof updateChatContactResponseSchema
>;
