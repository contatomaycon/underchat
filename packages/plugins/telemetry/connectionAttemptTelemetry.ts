...
const QR_GRPC_FASTPATH_DEADLINE_DEFAULT_MS = 5_000;
const QR_GRPC_FASTPATH_DEADLINE_MIN_MS = 2_000;
const QR_GRPC_FASTPATH_DEADLINE_MAX_MS = 30_000;
...
export function getConnectionQrGrpcFastPathDeadlineMs(): number {
  return readBoundedIntEnv(
    'CONNECTION_QR_GRPC_FASTPATH_DEADLINE_MS',
    QR_GRPC_FASTPATH_DEADLINE_DEFAULT_MS,
    QR_GRPC_FASTPATH_DEADLINE_MIN_MS,
    QR_GRPC_FASTPATH_DEADLINE_MAX_MS
  );
}
