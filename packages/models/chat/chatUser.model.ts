...
export const chatUser = pgTable(
  'chat_user',
  {
    ...
    notifications_status_update: boolean().notNull().default(true),
    notifications_status_queue: boolean().notNull().default(false),
    notifications_status_in_chat: boolean().notNull().default(true),
    notifications_status_chatbot: boolean().notNull().default(false),
    notifications_message_queue: boolean().notNull().default(false),
    notifications_message_in_chat: boolean().notNull().default(true),
    notifications_message_chatbot: boolean().notNull().default(false),
    notifications_transfer: boolean().notNull().default(true),
    notifications_internal_chat: boolean().notNull().default(true),
