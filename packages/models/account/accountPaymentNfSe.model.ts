...
export const accountPaymentNfSe = pgTable(
  'account_payment_nfse',
  {
  ...
  (table) => [
    index('account_payment_nfse_account_payment_id_idx').on(
      table.account_payment_id
    ),
    index('account_payment_nfse_account_payment_nfse_status_id_idx').on(
      table.account_payment_nfse_status_id
    ),
    index('account_payment_nfse_nfse_id_idx').on(table.nfse_id),
  ]
);
