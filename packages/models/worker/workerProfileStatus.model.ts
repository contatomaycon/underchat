...
export const workerProfileStatus = pgTable(
  ...
  (table) => [
    index('worker_profile_status_worker_id_idx').on(table.worker_id),
    index('worker_profile_status_worker_profile_status_type_id_idx').on(
      table.worker_profile_status_type_id
    ),
  ]
);
