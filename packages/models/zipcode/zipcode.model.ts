...
export const zipcode = pgTable(
  ...
  (table) => [
    index('zipcode_id_country_idx').on(table.id_country),
    index('zipcode_id_zipcode_city_idx').on(table.id_zipcode_city),
    index('zipcode_id_zipcode_district_idx').on(table.id_zipcode_district),
    index('zipcode_id_zipcode_state_idx').on(table.id_zipcode_state),
    index('zipcode_zipcode_idx').on(table.zipcode),
    index('zipcode_fiscal_code_idx').on(table.fiscal_code),
  ]
);
