...
import { ListContactChannelsResponseItem } from '@core/schema/contact/listContactChannels/response.schema';

@injectable()
export class ContactChannelsListerRepository {
  constructor(
  ...
  listChannelsByAccount = async (
    accountId: string
  ): Promise<ListContactChannelsResponseItem[]> => {
