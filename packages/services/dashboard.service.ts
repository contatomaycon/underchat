...
export class DashboardService {
  ...
  getDashboardOfflineChannels = async (
    ...
    // Connectivity is a safety-sensitive projection. A cached ONLINE result
    // can remain visible after the native client or PostgreSQL lease is lost,
    // so these reads intentionally go to the authoritative repository.
