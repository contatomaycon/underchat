    ...
    return `
      ...
      <html>
        <head>
          ...
          <style>
            body { font-family: Arial, "Noto Color Emoji", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "EmojiOne Color", "EmojiOne Mozilla", "Twemoji Mozilla", "Noto Emoji", sans-serif; padding: 24px; background: #f4f5f7; }
