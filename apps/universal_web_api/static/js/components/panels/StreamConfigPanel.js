    ...
    methods: {
        ...
        async loadParsers() {
            ...
            try {
                ...
                console.error('Falha ao carregar o analisador:', e);
            } finally {
        ...
        <div class="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-sm">
            ...
            <div class="px-4 py-3 border-b dark:border-gray-700 flex justify-between items-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white">📡 Monitoramento sem streaming</h3>
                    <span :class="[
                        ...
                        {{ isNetworkMode ? 'interceptação de rede' : 'DOM votação' }}
                    </span>
                </div>
            </div>
            ...
            <div v-show="!collapsed" class="p-4 space-y-4">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
                    <div>
                        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">modo de interceptação de rede</div>
                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Monitore solicitações de rede (se o site não estiver aberto por padrão, não abra)</div>
                    </div>
                ...
                <div v-if="isNetworkMode" class="space-y-4 border-t dark:border-gray-700 pt-4">
                    <div class="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2">
                        ...
                        Configuração de interceptação de rede                     </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">URL padrão de correspondência <span class="text-red-500">*</span></label>
                            <input type="text" :value="networkConfig.listen_pattern" @input="updateNetworkField('listen_pattern', $event.target.value)" placeholder="Por exemplo: StreamGenerate"
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">solicitação de rede URL Interceptar quando esta string estiver contida em</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">analisador de resposta <span class="text-red-500">*</span></label>
                            <select :value="networkConfig.parser" @change="handleParserChange($event.target.value)" @focus="loadParsers"
                                ...
                                <option value="" disabled>Selecione o analisador...</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempo limite da primeira resposta</label>
                            <div class="flex items-center gap-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempo limite silencioso</label>
                            <div class="flex items-center gap-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Intervalo de votação</label>
                            <div class="flex items-center gap-2">
                    ...
                    <div v-if="!networkConfig.listen_pattern || !networkConfig.parser"
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div class="text-sm text-yellow-700 dark:text-yellow-300">
                                <span class="font-medium">Configuração incompleta</span>
                                <p class="mt-0.5 text-xs">Por favor preencha URL Combine o padrão e selecione o analisador, caso contrário, retornará automaticamente para DOM modelo</p>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- DOM Descrição do modo -->
                <div v-else class="text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            <span class="font-medium text-gray-700 dark:text-gray-300">DOM Modo de votação</span>
                            <p class="mt-0.5">Extraia o conteúdo da resposta monitorando alterações nos elementos da página, com a melhor compatibilidade</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t dark:border-gray-700 pt-4">
                    <div class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Configuração comum</div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempo limite global</label>
                            <div class="flex items-center gap-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tempo limite silencioso (DOM)</label>
                            <div class="flex items-center gap-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">espera inicial</label>
                            <div class="flex items-center gap-2">
