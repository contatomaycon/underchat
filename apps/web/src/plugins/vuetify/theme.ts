...
export const themes: Record<string, ThemeDefinition> = {
  light: {
    ...
    colors: {
      ...
      tertiary: '#9C27B0',
      'on-tertiary': '#fff',
      'tertiary-darken-1': '#8E24AA',
      annotation: '#D4A574',
      'on-annotation': '#fff',
      'annotation-darken-1': '#C09564',
      distribution: '#4ECDC4',
      'on-distribution': '#fff',
      'distribution-darken-1': '#45B8B0',
      randomMessage: '#EC4899',
      'on-randomMessage': '#fff',
      'randomMessage-darken-1': '#DB2777',
      background: '#F8F7FA',
