...
<template>
  <div>
    <VCard :title="$t('current_plan')" no-padding>
      <VCardText>
        <VRow v-if="loading">
        ...
        <VRow
          v-else-if="planInvoice && planInvoice.plan_id"
          class="align-stretch"
        >
          <VCol cols="12" md="6" class="d-flex">
            <VCard variant="outlined" class="d-flex flex-column w-100">
              <VCardText class="d-flex flex-column flex-grow-1">
                ...
                <VDivider v-if="planInvoice.next_payment_date" class="my-4" />

                <div v-if="planInvoice.next_payment_date" class="mb-4">
                  ...
                  <p class="text-body-2 text-medium-emphasis">
                    {{ $t('subscription_expiration_notification') }}
                  </p>
                </div>
