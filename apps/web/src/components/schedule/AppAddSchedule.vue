...
const addSchedule = async () => {
  ...
  if (
    scheduleType === EScheduleType.text &&
  ...
  try {
    ...
    if (scheduleType === EScheduleType.chatbot && chatbotId.value) {
    ...
    if (!isOfficialWorker.value && message.value) {
          ...
          <VRow>
            ...
            <VCol v-if="showContactGroupsSelect" cols="12">
              ...
              <VAutocomplete
                ...
                :rules="[
                  (value) =>
                    requiredValidator(value, $t('contact_groups_required')),
                ]"
              />
            </VCol>
