...
const updateExpenditure = async () => {
  ...
  const payload: EditExpenditureParamsRequest = {
    expenditure_id: expenditureId.value,
  };

  const body: UpdateExpenditureRequest = {
    name: name.value,
    description: description.value || null,
    price: priceRaw.value,
  };

  const result = await expenditureStore.updateExpenditure(payload, body);
