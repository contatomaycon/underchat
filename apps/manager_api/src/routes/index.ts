...
import reportSatisfactionRoutes from './reportSatisfaction.route';
...
import voiceIaRoutes from './voiceIa.route';
...
export default function registerRoutes(server: FastifyInstance) {
  ...
  server.register(reportSatisfactionRoutes);
