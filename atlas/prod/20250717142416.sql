...
CREATE TABLE "permission_assignment" (
  ...
  CONSTRAINT "permission_assignment_api_key_id_api_key_api_key_id_fk" FOREIGN KEY ("api_key_id") REFERENCES "api_key" ("api_key_id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
