...
CREATE TABLE "user" (
  ...
  "permission_role_id" smallint NOT NULL,
  ...
  CONSTRAINT "user_permission_role_id_permission_role_permission_role_id_fk" FOREIGN KEY ("permission_role_id") REFERENCES "permission_role" ("permission_role_id") ON UPDATE NO ACTION ON DELETE NO ACTION,
